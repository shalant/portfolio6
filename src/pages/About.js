...
import './about.css';
import { SiMysql, SiRedux, SiMongodb, SiJest, SiMicrosoftword, SiMicrosoftexcel, SiMaterialui, SiPython, SiAmazonaws, SiDocker, SiKubernetes, SiWordpress, SiAnsible, SiJenkins, SiTerraform } from 'react-icons/si';
...
function About() {
    return (
        <div className='about'>
            ...
            <p className='about-text'>AWS-certified Cloud Practioner/MERN stack developer with a background in Music and BS in Chemistry. 20 years performing/ teaching music. Passionate about Cloud Computing, React, and working with a good team. Strong independent learner that enjoys pithy challenges. Looking forward to my new career creating value for a company.</p>
            <div className='icons'>
                <div className='fontawesome-icons'>
                    ...
                    <i class="fab fa-java fa-4x icons-wrap"></i>
                    <i class="fab fa-python fa-4x icons-wrap"></i>
                </div>
                <div className='react-icons'>
                    <IconContext.Provider value={{ size: '60px', margin: '50px 20px 5px', padding: '10px' }}>
                        ...
                        <SiAmazonaws className='react-icons' />
                        <SiDocker className='react-icons' />
                        <SiKubernetes className='react-icons' />
                        <SiWordpress className='react-icons' />
                        <SiAnsible className='react-icons' />
                        <SiJenkins className='react-icons' />
                        <SiTerraform className='react-icons' />
